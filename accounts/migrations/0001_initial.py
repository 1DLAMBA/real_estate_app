    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('admin', 'Administrator'), ('agent', 'Agent')], default='customer', max_length=20, verbose_name='User Type')),
                ...
                ('profile_rank', models.IntegerField(default=0, verbose_name='Profile Rank')),
